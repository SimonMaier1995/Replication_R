...
# 308 observations, 308/4=77 subjects
...
#aux <- subset(data_set, subset = idturk %in% "A2ZU492AC88KS")
# 4 observations
 
# excel  A17F3C6IFO42Q9 A1E77HZO63E334 A1M53J9C6XPDO A1HF64TV3AAOK6 A1QD1HNJRW4F6G A3BJTC39BU7R4V A2YIB84VKYNKWD
# A2ZU492AC88KS
# tested A17F3C6IFO42Q9 A1E77HZO63E334 A1M53J9C6XPDO A1HF64TV3AAOK6 A1QD1HNJRW4F6G A3BJTC39BU7R4V A2YIB84VKYNKWD
# A2ZU492AC88KS

# keep only useful variables ----

myvars <- c("batch","day","idturk","treatment","initialendowment", "initialendowmentupdated", 
            "pointssaving1","pointssaving2","pointsdebt1","pointsdebt2","balance_a1","balance_a2",
...
MSE_lowDebt$treatment <- "Redistribution Debt"
...
write.table(lambdaMatrix, "C:/Users/am04817/Dropbox/Behavioral debt experiment/NewDesign/StructuralEstimation/lambdaMatrixRedistributionDebt.txt",
            sep="\t", row.names = F)
