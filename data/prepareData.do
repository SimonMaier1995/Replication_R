...
if c(username)=="am04817" global path "/Users/am04817/Dropbox/Behavioral debt experiment/NewDesign"

global data "$path/Submission\Conditional Accepted\AddMaterial\data"
...
{
import delimited "$data/redistributionData.csv", clear
...
{
import delimited "$data/borrowingData.csv", clear
